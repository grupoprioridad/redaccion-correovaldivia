...
function getSiteDB(): PDO {
    static $p; if (!$p) $p = new PDO('mysql:host=170.187.205.201;dbname=elcorreodevaldivia;charset=utf8mb4','elcorreo_user',',e~vm!RAXdX3JKNf',[PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION,PDO::ATTR_DEFAULT_FETCH_MODE=>PDO::FETCH_ASSOC]);
    return $p;
}
