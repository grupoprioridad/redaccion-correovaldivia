    ...
    if ($action === 'aprobar') {
        ...
        if ($u) {
            ...
            <div style='font-family:sans-serif;max-width:600px;margin:0 auto;background:#111214;padding:2rem;border-radius:12px;border:1px solid rgba(255,255,255,0.08)'>
                ...
                <h3 style='color:#5e6ad2;font-size:.9rem;margin-bottom:.8rem'>📋 Resumen de condiciones</h3>
                <table style='color:#a0a4ab;font-size:.8rem;line-height:1.8;width:100%'>
                <tr><td style='padding:4px 0'><strong style='color:#f7f8f8'>✍️ Cesión de derechos:</strong> Al entregar una historia, cedes los derechos de publicación a El Correo de Valdivia. Puedes republicar en tu portafolio dando crédito.</td></tr>
                <tr><td style='padding:4px 0'><strong style='color:#f7f8f8'>⏰ Recordatorios:</strong> Correos a mitad del plazo y día antes del vencimiento.</td></tr>
                <tr><td style='padding:4px 0'><strong style='color:#f7f8f8'>⚖️ Penalización:</strong> Si entregas atrasado, se descuenta 10% del presupuesto por día (máx. 50%). A los 7 días la historia se reasigna.</td></tr>
                <tr><td style='padding:4px 0'><strong style='color:#f7f8f8'>🚫 Strikes:</strong> 3 reasignaciones por atraso = cuenta desactivada automáticamente.</td></tr>
                </table>
                <p style='margin-top:1rem'><a href='" . BASE_URL . "/condiciones.php' style='color:#5e6ad2;font-size:.8rem'>Ver condiciones completas →</a></p>
                <hr style='border-color:rgba(255,255,255,0.08);margin:1.5rem 0'>
                <p style='font-size:.8rem;color:#62666d'>El Correo de Valdivia · Sistema de Redacción</p>            </div>";
